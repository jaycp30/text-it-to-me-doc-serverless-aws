...
const PATHS = {
  ...
  /* GitHub — project/source contact */
  github: (
    <>
      <path d="M12 2.8a9.2 9.2 0 0 0-2.9 17.9c.46.08.63-.2.63-.44v-1.58c-2.56.56-3.1-1.1-3.1-1.1-.42-1.07-1.02-1.35-1.02-1.35-.84-.57.06-.56.06-.56.93.07 1.42.96 1.42.96.83 1.42 2.18 1.01 2.71.77.08-.6.32-1.01.59-1.24-2.04-.23-4.19-1.02-4.19-4.55 0-1 .36-1.82.95-2.46-.1-.23-.41-1.17.09-2.43 0 0 .78-.25 2.54.94A8.8 8.8 0 0 1 12 7.36c.79 0 1.58.11 2.32.32 1.76-1.19 2.53-.94 2.53-.94.51 1.26.19 2.2.09 2.43.6.64.95 1.46.95 2.46 0 3.54-2.15 4.31-4.2 4.54.33.29.63.85.63 1.71v2.38c0 .24.17.52.64.43A9.2 9.2 0 0 0 12 2.8Z" />
    </>
  ),
